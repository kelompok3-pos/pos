    ...
    public function index(): void
    {
        ...
        <head>
            ...
            <style>
                ...
                body { font-family: 'Plus Jakarta Sans', sans-serif; background: var(--bg-main); color: var(--text-main); margin: 0; }
                ...
                .sidebar-brand { padding: 32px 24px 20px; color: #fff; font-weight: 800; font-size: 1.4rem; border-bottom: 1px solid rgba(255,255,255,0.08); }
                ...
                .sidebar-nav a { display: flex; align-items: center; gap: 12px; padding: 14px 16px; border-radius: 12px; color: #d1fae5; text-decoration: none; font-size: 0.95rem; font-weight: 600; margin-bottom: 6px; }
                .sidebar-nav a.active { background: #34d399; color: #064e3b; font-weight: 700; }
                .main-content { margin-left: 260px; padding: 40px 48px; min-height: 100vh; }
                .topbar h1 { font-size: 1.9rem; font-weight: 800; color: var(--primary-dark); margin: 0; }
                .topbar p { color: var(--text-muted); font-size: 0.95rem; font-weight: 600; margin: 6px 0 0; }
                .date-badge { background: var(--bg-card); border: 2px solid #e2e8f0; border-radius: 12px; padding: 12px 20px; font-size: 0.95rem; font-weight: 700; display: flex; align-items: center; gap: 8px; }
                .stat-card { background: var(--bg-card); border-radius: 20px; padding: 28px; border: 1px solid #e2e8f0; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05); transition: transform 0.2s; }
                ...
                .stat-label { font-size: 0.85rem; color: var(--text-muted); font-weight: 700; text-transform: uppercase; margin-bottom: 6px; }
                .stat-value { font-size: 2rem; font-weight: 800; color: var(--primary-dark); }
                .card-box { background: var(--bg-card); border-radius: 24px; border: 1px solid #e2e8f0; overflow: hidden; }
                ...
                .card-box-header h5 { font-weight: 800; font-size: 1.1rem; color: var(--primary-dark); margin: 0; }
                .card-box-body { padding: 28px; }
                .table thead th { background: #f1f5f9; font-size: 0.8rem; font-weight: 700; text-transform: uppercase; color: var(--primary-dark); padding: 16px 20px; }
                .table tbody td { padding: 18px 20px; font-size: 0.95rem; font-weight: 600; border-bottom: 1px solid #e2e8f0; }
                ...
                .produk-rank.gold { background: #fef3c7; color: #92400e; }
                .produk-rank.silver { background: #f1f5f9; color: #475569; }
                .produk-rank.bronze { background: #ffedd5; color: #9a3412; }
                .produk-bar-wrap { flex: 1; }
                .produk-name { font-size: 0.95rem; font-weight: 700; margin-bottom: 6px; }
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="/kasir/transaction"><i class="bi bi-cart-fill"></i> Halaman Kasir</a>
            </nav>
        </aside>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-value" style="color: #047857;">
                            ...
                            if (function_exists('formatRupiah')) {
                                echo formatRupiah($totalPenjualan);
                            } else {
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="font-weight: 800; color: #047857;">
                                    <?php 
                                    if (function_exists('formatRupiah')) {
                                        echo formatRupiah($trx['total_price']);
                                    } else {
                                        echo 'Rp ' . number_format($trx['total_price'], 0, ',', '.');
                                    }
                                    ?>
                                </td>
