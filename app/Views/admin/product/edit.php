    ...
    <div class="sa-layout">
        <div>
            <div class="sa-info-box">
                ...
                <div>
                    <div class="sa-info-title">Informasi perubahan produk</div>
                    <div class="sa-info-text">
                        Perubahan harga dan stok akan langsung memengaruhi data yang tampil di kasir.
                        Pastikan nominal harga, stok, dan minimum stock sudah sesuai sebelum menyimpan.
                    </div>
                </div>
            </div>
            ...
            <div class="sa-panel">
                <div class="sa-panel-header">
                    ...
                    <div class="sa-panel-subtitle">
                        Ubah informasi produk yang sudah terdaftar di sistem.
                    </div>
                </div>
                            ...
                            <div class="sa-form-group">
                                ...
                                <div class="sa-input-wrap">
                                    ...
                                    <input
                                        ...
                                        id="minimum_stock"
                                        name="minimum_stock"
                                        value="<?= e((string) ($product['minimum_stock'] ?? 5)) ?>"
                                        min="0"
                                ...
                                <div class="sa-form-help">
                                    Produk akan masuk daftar peringatan jika stok mencapai batas ini.
                                </div>
                            </div>
                        </div>

                        <div class="sa-product-summary">
                            <div class="sa-summary-item">
                                <span class="sa-summary-label">ID Produk</span>
                            ...
                            <div class="sa-summary-item">
                                <span class="sa-summary-label">Status Produk</span>
                                <div class="sa-summary-value">
                                    <?= e(ucfirst($product['status'] ?? 'active')) ?>
                                </div>
                            </div>

                            <div class="sa-summary-item">
                                <span class="sa-summary-label">Monitoring</span>
                                <div class="sa-summary-value">
                                    Stok otomatis
                                </div>
                            </div>
